...
#define STRING_CONFIG_H_AUTHOR "(numelon.com, CR-10S)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
// MODIFIED: Common configuration for BL Touch
#define NOZZLE_TO_PROBE_OFFSET { -44.5, -8, -3.9 }
